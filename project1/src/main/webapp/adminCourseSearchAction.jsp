...
<%@ page import="user.TimeTable" %><html>
<head>
...
<div class="container">
  ...
  <div class="row">
    <table class="table" width="800" style="text-align: center; border: 1px solid #dddddd">
      ...
      %>
      <p>class_no : <%=_class_no%> </p>
      <p>course_id : <%=_course_id%></p>
      <p>교과목 : <%=_course_name%></p>
      </thead>
      <tbody>
      <%
        UserDAO userDAO = new UserDAO();//  수강편람페이지와 똑같음 코드 똑같음 코드 가져다씀 course_searchAction.jsp와 같음 설명도 거기있음
        ...
        //수강편람페이지와 똑같음 코드 똑같음 코드 가져다씀 course_searchAction.jsp와 같음 설명도 거기있음
      ...
      <tr>
        ...
        <td><%
          ...
          for(int j = 0; j < timelist.size(); j ++){
            ...
            String result = day + sStr.substring(11,15) + " ~ " + eStr.substring(11,15) + "0";
        %>
          <%=result%><br>
          <%
            }
