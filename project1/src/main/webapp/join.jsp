    ...
    <div class="container">
        ...
        <div class="col-lg-4">
            <div class="jumbotron" style="padding-top: 20px;">
                <form method="post" action="joinAction.jsp"> <!-- action="joinAction.jsp"은 form에서 입력받은 것을 joinAction.jsp로 보냄 -->
                    ...
                    <div class="form-group" style="test-align: center;">
                    	<div class="btn-group" data-roggle="buttons">
                    		<label class="btn btn-primary"> //text로 랜더링되지만, 마우스로 클릭할 경우 연결된 요소로 선택
